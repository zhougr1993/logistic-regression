...
#include <stdio.h>
#include <stdlib.h>
// refer to Matrix row u can get it from http://eigen.tuxfamily.org/dox/group__TutorialMatrixArithmetic.html
...
class SimpleDataLoader {
    ...
    private:
        ...
        // add a default feature to each instance and set the feature weight to 1
        bool parse_line(const string& line, int& cat, const int line_num, MatrixXd &x) {
    ...
    public:
        ...
        void load_file(char*& file_path, VectorXd& y, MatrixXd& x) {
